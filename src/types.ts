...
export interface LLMConfig {
  provider: 'claude' | 'openai' | 'ollama' | 'deepseek' | 'claude-code' | 'antigravity-cli' | 'gemini-cli' | 'copilot-cli' | 'codex-cli' | 'openclaw-cli' | 'hermes-cli' | 'codebuddy-cli' | 'cline-cli' | 'opencode-cli' | 'dsh-cli' | (string & {});
